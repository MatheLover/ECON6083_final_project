...
iv_ROBUST_5 <- coeftest(iv,vcov=vcovHC(iv, type = "HC0"))
...
iv_ROBUST_6 <- coeftest(iv,vcov=vcovHC(iv, type = "HC0"))
...
iv_ROBUST_7 <- coeftest(iv,vcov=vcovHC(iv, type = "HC0"))
...
iv_ROBUST_8 <- coeftest(iv,vcov=vcovHC(iv, type = "HC0"))
...
rf_1 <- coeftest(rf_1,vcov=vcovHC(iv, type = "HC0")) # disapperance of bprvdist if we run this line
...
rf_2 <- coeftest(rf_1,vcov=vcovHC(iv, type = "HC0"))
...
rf_3 <- coeftest(rf_3,vcov=vcovHC(iv, type = "HC0")) # disapperance of bprvdist if we run this line
...
rf_4 <- coeftest(rf_4,vcov=vcovHC(iv, type = "HC0")) # disapperance of bprvdist if we run this line
