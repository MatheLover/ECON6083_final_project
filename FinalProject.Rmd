...
We believe lnnightlight is not solely a control variable and it definitely affects average years of schooling as well as share of population with different educ levels.And this makes sense, because night-time lights measure economic prosperity and people in more affluent areas are more likely and willing to invest in human capital, which means studying longer and obtaining higher degrees at schools.

And we wish authors to examine which factor -- nightlight vs jinshi pop -- affects human capital outcomes to a greater extent not only from the comparison between coefficients in scale but from common sense? It seems that they currently don't have such a discussion. 
...
```
The estimates are roughly the same compared to the original table.
