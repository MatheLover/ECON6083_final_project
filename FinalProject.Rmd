...
```
Summary: The two tables give roughly the same estimates of bprvdist and lnjinshipop, suggesting that ML approach can also be a effective strategy apart from traditional regressions.
